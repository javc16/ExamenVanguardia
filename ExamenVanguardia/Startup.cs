...
namespace ExamenVanguardia
{
    public class Startup
    {
        ...
        options => options.UseSqlServer("name=ConnectionStrings:DefaultConnection"));
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "ExamenVanguardia", Version = "v1" });
            });
        }
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "ExamenVanguardia v1"));
            }
